...
BEGIN_MESSAGE_MAP(CMFCChatClientDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_AUTOSEND_RADIO, &CMFCChatClientDlg::OnBnClickedRadio1)
	ON_CBN_SELCHANGE(IDC_COLOUR_COMBO, &CMFCChatClientDlg::OnCbnSelchangeCombo1)
...
void CMFCChatClientDlg::OnBnClickedRadio1()
{
	// TODO: 在此添加控件通知处理程序代码
}
